...
func (_m *MockDoer) DoThisToo(_param0 int, _param1 int) int {
	ret := _m.ctrl.Call(_m, "DoThisToo", _param0, _param1)
	ret0, _ := ret[0].(int)
	return ret0
}

func (_mr *_MockDoerRecorder) DoThisToo(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "DoThisToo", arg0, arg1)
}
